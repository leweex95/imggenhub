#!/usr/bin/env python
"""
Precision availability checking for HuggingFace models.
Checks what precision variants are available for a given model.
"""
...
class PrecisionAvailabilityChecker:
    """Checks available precision variants for a model."""

    def __init__(self, hf_token: Optional[str] = None):
        self.hf_token = hf_token
        self.headers = {"Authorization": f"Bearer {hf_token}"} if hf_token else {}

    def get_available_precisions(self, model_id: str) -> list:
    ...
    def _extract_precision_from_filename(self, filename: str) -> Optional[str]:
        ...
        return None  # No precision indicator found
